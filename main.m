...
G=cell(n,2+2*wide);
    ...
    text=[text num2str(10) '@ATTRIBUTE class	numeric' num2str(10) num2str(10) '@DATA'];


dlmwrite(name,[text num2str(13) num2str(10) fileread(name)],'delimiter','');
